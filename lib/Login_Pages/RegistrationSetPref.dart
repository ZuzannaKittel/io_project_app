...
class PersonalDataReg extends StatefulWidget {
  const PersonalDataReg({Key? key}) : super(key: key);

  @override
  State<PersonalDataReg> createState() => PersonalDataRegState();
}
...
class PersonalDataRegState extends State<PersonalDataReg> {
  @override
